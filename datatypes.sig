signature QBE_TYPES =
  sig
    datatype ty = W | L | S | D | B | H | Agg of Atom.atom
    ...
    datatype const =
    Int of Int64.int | Flts of Real32.real | Fltd of Real64.real

    datatype dataitem =
    DataSym of Atom.atom * int | DataStr of string | DataCon of const

    datatype datafield = DataTy of ty * dataitem list | DataZ of int
    ...
    datatype value = Tmp of Atom.atom | Glo of Atom.atom | Con of const

    type phi = {temp : (Atom.atom * ty), args : (Atom.atom * value) list}
    ...
    type call = { result : (Atom.atom * ty) option
                ...
                , envp : value option
                , args : (ty * value) list
                (* index of first variadic argument in `args` or `length args`
                 * if a variadic function is called with no variadic arguments
                 *)
                , vararg : int option
                }
